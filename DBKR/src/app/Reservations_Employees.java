 ...
 * @author Tihomir
 */
public class Reservations_Employees extends javax.swing.JFrame {

    /**
     * Creates new form Reservations_Employees
     */
    public Connect query = new Connect();
    public Reservations_Employees() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Резервирай маса");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(columns[4]!= Mass2.toString()&&columns[5]!=ArrivalDate2.toString()){
            query.insert(
                ...
                new String[]{CustomerName2.toString(),CustomerPhone2.toString(),
                    Mass2.toString(),ArrivalDate2.toString(),Hour2.toString(),People2.toString()}
            );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reservations_Employees.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reservations_Employees().setVisible(true);
            }
        });
    }
